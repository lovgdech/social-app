  ...
  return (
    <div className="relative w-full h-max border border-stone-300 rounded-lg bg-white mt-4 overflow-hidden">
      <div className="w-full flex border-b border-stone-300">
        <div className="max-w-[350px] w-full flex items-center justify-between h-16 px-2">
          <input
      ...
      <div className="relative w-full h-[520px] flex overflow-hidden">
        <div className="w-full h-full max-w-[350px] overflow-auto flex flex-col py-2">
          <InboxMemberItem />
          <InboxMemberItem />
          <InboxMemberItem />
          <InboxMemberItem />
        ...
        <div className="h-full flex-1 flex flex-col overflow-hidden">
          <div className="w-full h-full overflow-scroll overflow-x-hidden px-4 bg-stone-100 border-b py-4">
            <ul className="w-full h-full flex flex-col gap-2 items-end">
              ...
              <li className="relative text-white bg-sky-600 rounded-md w-max max-w-[50%]">
