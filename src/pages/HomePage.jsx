...
function HomePage() {
  return (
    <div className="w-full h-full px-5 mt-5 flex gap-5 justify-between">
      <div className="hidden lg:flex flex-1 w-[300px] h-full overflow-hidden overflow-y-auto flex-col gap-2 pb-32 no-scrollbar">
        <Blog />
      </div>
      ...
      <div className="hidden md:flex flex-1 w-[300px] h-full overflow-hidden overflow-y-auto flex-col gap-2 no-scrollbar pb-32">
        <ActiveUser />
        <GroupsList />
        <MemberList />
      </div>
